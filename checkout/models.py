...
class Order(models.Model):
    ...
    town_or_city = models.CharField(max_length=40, null=True, blank=True, default='Unknown')
    street_address1 = models.CharField(max_length=80, null=True, blank=True, default='')
